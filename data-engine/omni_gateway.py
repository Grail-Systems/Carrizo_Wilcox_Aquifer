...
async def compile_permits():
    ...
    mega_permits = [
        ...
        {"title": "Shelby County Water Export Hub", "applicant": "Texas Water Holdings", "bottom_line": "Commercial export pipeline. Pumping 8,500 acre-feet/yr out of the district for profit.", "raw_volume": 8500, "coordinates": [-94.180, 31.790], "source_url": "https://www.tceq.texas.gov/"},
